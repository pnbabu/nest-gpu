...
pg_list = pg.ToList()
# here an additional pg is created and not connected to test
# that the simulation does not fail in case of unconnected devices
pg2 = ngpu.Create("poisson_generator")
